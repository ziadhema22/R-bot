...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('online-token')
        .setDescription('بروجيكت-𝐓𝐨𝐤𝐞𝐧𝐎𝐧𝐥𝐢𝐧𝐞'),
    ...
    async execute(interaction, client) {
        ...
        let Embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                {name: '<:design:1002001716897660948> Remix/Fork To Edit Projects:', value: '> <:glitch:1002001593551564810> not here \n>  <:replit:1002001459916849162> [Replit Project](https://replit.com/@complexe1337/Token-online-24h-1#hosting.js)'},
                )
            .setTimestamp()
